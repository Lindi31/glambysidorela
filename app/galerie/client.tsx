            ...
            >
              {shown.map((item, i) => (
                <motion.div
                  ...
                  className="rounded-3xl bg-white border border-nude/60 overflow-hidden cursor-pointer group hover:border-rose/40 hover:shadow-lg transition-all duration-300"
