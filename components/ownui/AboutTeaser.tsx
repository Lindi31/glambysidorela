    ...
    <section className="py-24 lg:py-32 bg-cream">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative aspect-[4/5] rounded-[40px] overflow-hidden bg-gradient-to-tl from-mauve via-rose/40 to-nude shadow-2xl">
          ...
          {/* Accent shape */}
          <div
            className="absolute -top-6 -right-6 w-32 h-32 rounded-full bg-gold/30 -z-10"
            aria-hidden
          />
          <div
            className="absolute -bottom-4 -left-4 w-24 h-24 rounded-full border-2 border-rose/40"
            aria-hidden
          />
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4 text-charcoal/70 text-lg leading-relaxed">
            ...
            <p>
              Was mich antreibt: das Gefühl, wenn eine Kundin den Spiegel
              sieht und lächelt. Genau dieses Handwerk und dieses Gefühl gebe
              ich auch in meinen Schulungen an angehende Artists weiter.
            </p>
          </div>
